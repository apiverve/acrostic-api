# Acrostic Puzzle Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:acrostic-api:1.1.12'
}
```
...
```java
import com.apiverve.acrostic.AcrosticPuzzleGeneratorAPIClient;
import com.apiverve.acrostic.APIResponse;
import com.apiverve.acrostic.APIException;

// Initialize the client
AcrosticPuzzleGeneratorAPIClient client = new AcrosticPuzzleGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/acrostic](https://docs.apiverve.com/ref/acrostic)
...
- **Documentation:** [https://docs.apiverve.com/ref/acrostic](https://docs.apiverve.com/ref/acrostic)
- **Issues:** [GitHub Issues](https://github.com/apiverve/acrostic-api/issues)
