...
// Request contains the parameters for the Acrostic Puzzle Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Acrostic Puzzle Generator API.
type ResponseData struct {
	Keyword string `json:"keyword"`
	Theme string `json:"theme"`
	Lines []LinesItem `json:"lines"`
	LineCount int `json:"lineCount"`
	Html string `json:"html"`
}

// LinesItem represents an item in the Lines array.
